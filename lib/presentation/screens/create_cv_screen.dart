...
class _HomeScreenState extends ConsumerState<CreateCvScreen> {
  ...
  final TextEditingController _institutioHighController = TextEditingController();
  final TextEditingController _startHighStudyController = TextEditingController();
  ...
  final String _nivelTerciario = 'Terciario en Curso';
  ...
  void _guardarCV() async {
    ...
    final userCv = UserCv(
      ...
      nationality: _nationalityController
          .text, // Puedes completar esto según tus necesidades
    ...
    final highStudies =
        _highEducacion.where((e) => e['nivelTerciario'] != null).map((e) {
      return HighStudy()
        ..institutionName = e['institution'] ?? ''
        ..degree = e['titulo'] ?? ''
        ..startDate = e['desde'] ?? ''
              ...
              for (var edu in _educacion)
                ExpansionTile(
                  ...
                  children: [
                    ListTile(
                        title: Text(
                            'Nivel Secundario: ${edu['nivelSecundario']}')),
                  ],
                ),
            ...
            children: [
              for (var highEducacion in _highEducacion)
                ExpansionTile(
                  ...
                  children: [
                    ListTile(
                      title: Text(highEducacion['nivelTerciario']!),
                    ),
                  ],
                ),
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Institución de Estudios'),
                validator: (value) {
                  if (_highEducacion.isEmpty &&
                      (value == null || value.isEmpty)) {
                    return 'Por favor ingrese el nombre de la institución';
                  }
                  return null;
      ...
      body: Stepper(
        ...
        onStepContinue: () {
          if (_formKeys[_index].currentState!.validate() ||
              (_index == 4 && _experiencias.isNotEmpty) ||
              (_index == 5 &&
                  (_nivelSecundario == 'Secundario En Curso' ||
                      _nivelSecundario == 'Secundario Incompleto')) || _nivelTerciario == 'Terciario en Curso' ||
                      
              (_index == 6 && _conocimientos.isNotEmpty)) {
